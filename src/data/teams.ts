...
function extractLeaguesFromJSON(): Record<
  string,
...
export const TEAMS: Team[] = [
  // ===== LALIGA EA SPORTS (20 equipos) =====
  {
    ...
    mid: 90,
    def: 88,
    stars: ["Mbappé", "Bellingham", "Vinicius Jr."],
    color: "#FFFFFF",
  },
  {
    id: "bar",
    ...
    mid: 88,
    def: 84,
    stars: ["Lamine Yamal", "Pedri", "Lewandowski"],
    color: "#A50044",
  },
  {
    id: "atm",
    ...
    mid: 84,
    def: 87,
    stars: ["Griezmann", "Julián Álvarez", "Oblak"],
    color: "#CB3524",
  },
  {
    id: "ath",
    ...
    mid: 79,
    def: 81,
    stars: ["Nico Williams", "Iñaki Williams"],
    color: "#EE2523",
  },
  {
    id: "rso",
  ...
  },
  {
    ...
    mid: 88,
    def: 86,
    stars: ["Salah", "Van Dijk", "Szoboszlai"],
    color: "#C8102E",
  },
  {
    id: "ars",
  ...
  },
  {
    ...
    mid: 82,
    def: 80,
    stars: ["Bruno Fernandes", "Garnacho"],
    color: "#DA291C",
  },
  {
    id: "new",
  ...
  // ===== Ascensos temporada 2025/26 (añadidos automáticamente) =====
  {
    id: "ce",
    name: "CD Eldense",
    short: "CDE",
    ...
    mid: 67,
    def: 64,
    stars: ["Justin Smith", "Fidel", "Floris Smand"],
    color: "#1a1a2e",
  },
  {
    id: "ct",
    ...
    mid: 66,
    def: 66,
    stars: ["Mauro Pittón", "Enric Gallego", "Nacho Gil"],
    color: "#16213e",
  },
  {
    id: "cf",
    ...
    mid: 65,
    def: 65,
    stars: ["Hugo Burcio", "Joel López", "Coke Carrillo"],
    color: "#0f3460",
  },
  {
    id: "csf",
    ...
    mid: 70,
    def: 66,
    stars: ["Pere Pons", "Nicholas Gioacchini", "Pipa"],
    color: "#533483",
  },
  {
    id: "cc",
    ...
    mid: 72,
    def: 72,
    stars: ["Carl Rushworth", "Matt Grimes", "Gustavo Hamer"],
    color: "#e94560",
  },
  {
    id: "hc",
    ...
    mid: 71,
    def: 71,
    stars: ["Konstantinos Tzolakis", "Hidemasa Morita", "Jack Butland"],
    color: "#2c3e50",
  },
  {
    id: "it",
    ...
    mid: 74,
    def: 74,
    stars: ["Daizen Maeda", "Saša Lukić", "Julio César Enciso"],
    color: "#8e44ad",
  },
  {
    id: "fro",
    ...
    mid: 69,
    def: 68,
    stars: ["Romano Schmid", "Florian Grillitsch", "Giacomo Calò"],
    color: "#2980b9",
  },
  {
    id: "monz",
    ...
    mid: 69,
    def: 69,
    stars: ["Matteo Pessina", "Andrea Colpani", "Samuele Birindelli"],
    color: "#27ae60",
  },
  {
    id: "ven",
    ...
    mid: 70,
    def: 69,
    stars: ["Albion Rrahmani", "Lorenzo Montipò", "Gianluca Busio"],
    color: "#e67e22",
  },
  {
    id: "fs0",
    ...
    mid: 69,
    def: 69,
    stars: ["Robin Gosens", "Edin Džeko", "Loris Karius"],
    color: "#c0392b",
  },
  {
    id: "sp0",
    ...
    short: "SCP",
    city: "SC Paderborn 07",
    league: "bundesliga",
    att: 66,
    mid: 69,
    def: 67,
    stars: ["Laurin Curda", "Raphael Obermair", "Felix Götze"],
    color: "#16a085",
  },
  {
    id: "se",
    ...
    mid: 68,
    def: 68,
    stars: ["Lukas Petkov", "Noel Futkeu", "Luca Sirch"],
    color: "#1a1a2e",
  },
  {
    id: "eta",
    ...
    mid: 67,
    def: 66,
    stars: ["Junior Diaz", "Antoine Mille", "Adrien Monfray"],
    color: "#16213e",
  },
  {
    id: "lmf",
    ...
    mid: 65,
    def: 70,
    stars: ["Djibril Sidibé", "Billal Brahimi", "Torrente"],
    color: "#0f3460",
  },
];
...
function generateDynamicTeams(): Team[] {
  ...
  return playableTeams.map(([key, data], i) => {
    ...
    const avgOvr =
      sorted.length > 0
        ? Math.round(sorted.reduce((s: number, p: any) => s + (p.OVR || 70), 0) / sorted.length)
        : 70;
    const att =
      Math.round(
        sorted
          .filter((p: any) => ["ST", "CF", "LW", "RW", "LF", "RF", "CAM"].includes(p.Position))
          .reduce((s: number, p: any, _: number, arr: any[]) => s + (p.OVR || 70) / arr.length, 0),
      ) || avgOvr;
    const def =
      Math.round(
        sorted
          .filter((p: any) => ["CB", "LB", "RB", "LWB", "RWB"].includes(p.Position))
          .reduce((s: number, p: any, _: number, arr: any[]) => s + (p.OVR || 70) / arr.length, 0),
      ) || avgOvr;
    const mid =
      Math.round(
        sorted
          .filter((p: any) => ["CM", "CDM", "CAM", "LM", "RM"].includes(p.Position))
          .reduce((s: number, p: any, _: number, arr: any[]) => s + (p.OVR || 70) / arr.length, 0),
      ) || avgOvr;
    return {
      id: key,
