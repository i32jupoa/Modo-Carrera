...
export const Route = createFileRoute("/europa-league")({ component: EuropeanCompetitionPage });
...
function FixtureRow({
  ...
  return (
    <div
      className={`flex items-center gap-2 px-3 py-2 hover:bg-muted/30 text-sm ${isUser ? resultBg || "bg-orange-950/20 border-l-2 border-orange-400" : ""} ${played ? "cursor-pointer" : ""}`}
        ...
        <div className="flex items-center justify-between gap-6 min-h-[900px] py-8">
          ...
          <div className="flex-1 flex items-center gap-4">
            ...
            <div className="flex-1 flex flex-col justify-around gap-8">
              <div className="text-center text-sm font-bold text-orange-400 uppercase tracking-wider mb-4">
                Play-off
              </div>
...
function EuropeanCompetitionPage() {
  ...
  const competition = "uel" as const;
  ...
  if (!ucl || !ucl.phase || !ucl.participants) {
    return (
      <div className="p-6 text-center space-y-2">
        ...
        <h2 className="text-xl font-bold">UEFA Europa League</h2>
        <p className="text-muted-foreground">
          UEFA Europa League comparte el formato de la Champions: sorteo, fase de liga, play-offs, eliminatorias y final.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="bg-gradient-to-r from-orange-950 to-orange-950 border-b border-border px-4 py-5">
                            ...
                            (() => {
                              ...
                              return (
                                <div className="rounded-lg border border-border overflow-hidden">
                                  <div className="bg-orange-950/60 px-4 py-2.5 flex items-center justify-between">
                                    <div>
