...
function SoccerBallIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <path d="M12 2L15 8L12 12L9 8L12 2Z" fill="currentColor" />
      <path d="M12 22L9 16L12 12L15 16L12 22Z" fill="currentColor" />
      <path d="M2 12L8 9L12 12L8 15L2 12Z" fill="currentColor" />
      <path d="M22 12L16 15L12 12L16 9L22 12Z" fill="currentColor" />
      <path d="M4 4L8 8L12 12L8 16L4 4Z" fill="currentColor" />
      <path d="M20 4L16 8L12 12L16 16L20 4Z" fill="currentColor" />
    </svg>
  );
}
...
function TrophyIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      />
      {/* Trophy stem */}
      <path d="M9 13V16H15V13" fill="none" stroke="currentColor" strokeWidth="1.5" />
      {/* Trophy base */}
      <path d="M7 16H17" stroke="currentColor" strokeWidth="1.5" />
      <path d="M8 16V18H16V16" fill="none" stroke="currentColor" strokeWidth="1.5" />
      {/* Star on trophy */}
      <path
      ...
      <DialogPrimitive.Portal>
        ...
        >
          <div className="flex flex-col space-y-1.5 text-center sm:text-left">
            <h2 className="text-2xl font-black">Sorteo de Copa Nacional - {roundLabel}</h2>
          </div>

          {mode === "select" && (
            <div className="space-y-6 py-6">
              <p className="text-muted-foreground">
                {teams.length} equipos clasificados para esta ronda. Elige cómo quieres realizar el
                sorteo:
              </p>
              ...
              <div className="bg-muted/50 p-4 rounded-lg text-sm text-muted-foreground space-y-2">
                <p>
                  <strong>Simulación Rápida:</strong> Empareja todos los equipos instantáneamente de
                  forma aleatoria.
                </p>
                <p>
                  <strong>Simular Sorteo:</strong> Revela los equipos uno por uno con animación para
                  crear suspense.
                </p>
              </div>
            </div>
                    ...
                    >
                      <div className="flex items-center gap-3 flex-1 justify-end">
                        <TeamLogo
                          ...
                          leagueName={getLeagueName(homeTeam?.league || "")}
                          size={24}
                        />
                      ...
                      <div className="flex items-center gap-3 flex-1 justify-start">
                        ...
                        <TeamLogo
                          ...
                          leagueName={getLeagueName(awayTeam?.league || "")}
                          size={24}
                        />
                      </div>
                    </div>
          ...
          {mode === "interactive" && (
            <div className="space-y-6 py-6">
              ...
              {interactiveMatchups.length > 0 &&
                !isAnimating &&
                interactiveMatchups.length * 2 === teams.length && (
                  <div className="flex gap-3 justify-end">
                    <Button onClick={handleComplete} className="glow-neon">
                      Confirmar Emparejamientos
                    </Button>
