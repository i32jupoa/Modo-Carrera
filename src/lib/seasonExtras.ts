...
const CLUB_NEWS = [
  (t: string) => ({
    title: `Entrenamiento intenso en ${t}`,
    text: "El cuerpo técnico ha redoblado el trabajo físico esta semana.",
  }),
  (t: string) => ({
    title: `La afición de ${t} llena el estadio`,
    text: "Récord de abonados para el próximo partido.",
  }),
  (t: string) => ({
    title: `Reunión de capitanes en ${t}`,
    text: "Los líderes del vestuario piden unidad para la racha.",
  }),
  (t: string) => ({
    title: `${t} prepara una sorpresa táctica`,
    text: "Trabajan variantes de presión alta de cara al rival.",
  }),
];
const LIGA_NEWS = [
  () => ({
    title: "Jornada cargada de duelos directos",
    text: "Varios cruces entre rivales por puestos europeos.",
  }),
  () => ({
    title: "El VAR vuelve a ser protagonista",
    text: "Decisiones polémicas marcan la jornada anterior.",
  }),
  () => ({
    title: "Repunte goleador en la liga",
    text: "Media histórica de goles por partido en este tramo.",
  }),
  () => ({
    title: "El liderato cambia de manos",
    text: "El nuevo líder amplía distancia con sus perseguidores.",
  }),
];
const MERCADO_NEWS = [
  () => ({
    title: "Rumores de fichaje invernal",
    text: "Varios clubes sondean a cracks emergentes.",
  }),
  () => ({
    title: "Renovación cerca para una estrella",
    text: "Su agente y el club avanzan posiciones.",
  }),
  () => ({
    title: "Oferta sorpresa desde Arabia",
    text: "Un club saudí estaría dispuesto a romper el mercado.",
  }),
  () => ({
    title: "Cláusula activada por un grande europeo",
    text: "Movimiento bomba en las próximas horas.",
  }),
];
...
export const THEMES: Record<CentralTheme["id"], CentralTheme> = {
  ...
  ucl: {
    ...
    bgOverlay: "bg-[radial-gradient(ellipse_at_top,_rgba(37,99,235,0.18),_transparent_60%)]",
  ...
  cup: {
    ...
    bgOverlay: "bg-[radial-gradient(ellipse_at_top,_rgba(217,119,6,0.18),_transparent_60%)]",
